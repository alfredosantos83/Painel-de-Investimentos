...
INSERT OR IGNORE INTO users (username, password, email, role, enabled) VALUES
...
INSERT OR IGNORE INTO products (nome, tipo, rentabilidade, risco, prazo_minimo_meses, prazo_maximo_meses, valor_minimo, valor_maximo, liquidez_dias, ativo, descricao) VALUES
...
INSERT OR IGNORE INTO clients (nome, cpf, email, data_cadastro, volume_total_investido, frequencia_movimentacoes, preferencia_investimento, perfil_risco, pontuacao_risco) VALUES
...
INSERT OR IGNORE INTO investments (client_id, tipo, valor, rentabilidade, data, prazo_meses, status) VALUES
...
INSERT OR IGNORE INTO simulations (client_id, product_id, valor_investido, valor_final, rentabilidade_efetiva, prazo_meses, data_simulacao, imposto_renda, valor_liquido) VALUES
